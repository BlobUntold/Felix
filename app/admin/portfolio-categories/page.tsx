...
.order('sort_order', { ascending: true });
 ...
 <p className="card-meta">New Portfolio Category</p>
...
: 'form-status form-status-error'
 ...
 <div className="detail-panel">
 <p className="card-meta">Existing Portfolio Categories</p>
 ...
 <a href={`/admin/portfolio-categories/${category.id}`} className="button-secondary">
 Edit
 </a>
 </div>
</div>))}
 ...
 <p>No portfolio categories yet.</p>
 )}
 </div>
 </div>
 </div>
