...
export default function EditPortfolioCategoryPage({ params }: PageProps) {
...
.single();
 ...
 const category = data as PortfolioCategory;
...
.eq('id', categoryId);
 ...
 'Delete this portfolio category? Portfolio items using it may lose their category link.'
 );
...
.eq('id', categoryId);
 ...
 <h1 className="section-title">Edit Portfolio Category</h1>
